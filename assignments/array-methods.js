...
const runnerAndSirtSize = runners.map((runner) => {
    return {'firstName': runner.first_name, 'lastName': runner.last_name, 'shirtSize': runner.shirt_size};
});
console.log(runnerAndSirtSize);
...
averageDonation  = runners.reduce( function(accumulator, currentValue) {
    return accumulator + currentValue.donation;
  }, 0) / runnersTotal;
